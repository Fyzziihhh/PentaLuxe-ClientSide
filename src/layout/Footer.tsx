...
const Footer = () => {
  return (
    <>
    <div className=" px-20 py-5 bg-secondary text-sm font-gilroy">
      ...
      <div className="flex justify-between  ">
        ...
        <ul>
          <li className="font-almendra text-lg *:"><h2>Our Story</h2></li>
          <li className="w-80">
       ...
       <ul>
        <li><h2 className="font-almendra text-xl ">Legal Information </h2></li>
        <li>Terms & Conditions</li>
        <li>Cookie Policy</li>
        <li>Accessibitily Statement</li>
       </ul>
      </div>
      <p className="text-center mt-3 mr-24">© 2024 PentaLuxe. All rights reserved.</p>
      </div>
    </>
  );
};
