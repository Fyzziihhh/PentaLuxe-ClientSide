  ...
  return (
    <div className="bg-secondary p-3 -mt-5">
      ...
      <div className="shipping-address">
        ...
        {
                        order.items.map(item=>  <div key={item.productId} className='flex gap-5 mt-3'>
                            <img height={50} width={90} src={item.productImage} alt="100x10 placeholder image" className='rounded-md'/>
...
<div className="order-summary">
    <h1 className="font-Quando text-2xl mt-5">Order Summary
    </h1>
    <p className="font-montserrat font-bold">Subtotal: ₹ {order.totalAmount-40}</p>
    <p className="font-montserrat font-bold">Shipping: ₹ 40</p>
    <div className="h-[1px] w-[20%] bg-slate-500 mt-3"></div>
    <h1 className="font-montserrat font-bold text-xl mt-2">Total : ₹ {order.totalAmount}</h1>
</div>
